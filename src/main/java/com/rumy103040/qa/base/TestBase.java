package com.rumy103040.qa.base;
...
import com.rumy103040.qa.util.WebEventListener;
...
public class TestBase {
	...
	public TestBase(){
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream(System.getProperty("user.dir")+ "/src/main/java/com/rumy103040"
